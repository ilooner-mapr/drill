...
public class TestOrderedPartitionExchange extends PopUnitTestBase {
  ...
  public void twoBitTwoExchangeRun() throws Exception {
    ...
    try(Drillbit bit1 = new Drillbit(CONFIG, SystemOptionManager.DEFAULT_VALIDATORS, serviceSet);
        Drillbit bit2 = new Drillbit(CONFIG, SystemOptionManager.DEFAULT_VALIDATORS, serviceSet);
      ...
      for(QueryDataBatch b : results) {
        if (b.getData() != null) {
          ...
          RecordBatchLoader loader = new RecordBatchLoader(new BootStrapContext(config, SystemOptionManager.DEFAULT_VALIDATORS, ClassPathScanner.fromPrescan(config)).getAllocator());
